...
if (isset($_GET['m_do'])) {
	...
	if ($do === 'mesourApp-editableTest-referenceData') {
		...
		echo '{"data":{"fields":[{"name":"role","title":"Role","type":"enum","params":[{"id":0},{"id":1}],"values":{"admin":{"key":"admin","name":"Admin"},"moderator":{"key":"moderator","name":"Moderator"}},"nullable":true},{"name":"name","title":"Name","type":"text","params":[{"id":0},{"id":1}],"rules":[{"type":"email","message":"Test email message.","arg":null},{"type":"filled","message":"Test error message.","arg":null}],"nullable":true,"hasTextarea":"true"},{"name":"surname","title":"Surname","type":"text","params":[{"id":0},{"id":1}],"rules":[],"nullable":false,"hasTextarea":"false"},{"name":"email","title":"Email","type":"text","params":[{"id":0},{"id":1}],"rules":[],"nullable":false,"hasTextarea":"false"},{"name":"last_login","title":"Last login","type":"date","params":[{"id":0},{"id":1}],"format":"YYYY-MM-DD HH:mm:ss","nullable":true},{"name":"amount","title":"Amount","type":"number","params":[{"id":0},{"id":1}],"rules":[{"type":"numeric","message":"Value must be valid number.","arg":null}],"unit":"EUR","separator":".","decimalPoint":",","decimals":2,"nullable":true},{"name":"has_pro","title":"Has PRO","type":"bool","params":[{"id":0},{"id":1}],"nullable":true,"description":"Has PRO"},{"name":"companies","title":"Companies","type":"many_to_many","params":[{"id":0,"attach_row":true,"create_new_row":true,"remove_row":true},{"id":1,"attach_row":true,"create_new_row":true,"remove_row":true}],"reference":{"table":"companies","primary_key":"id","column":"user_id","pattern":"{name}","self_column":"company_id","referenced_table":"user_companies"}},{"name":"group","title":"Group","type":"many_to_one","params":[{"id":0,"edit_current_row":true,"create_new_row":true,"remove_row":false},{"id":1,"edit_current_row":true,"create_new_row":true,"remove_row":false}],"reference":{"table":"groups","primary_key":"id","column":"group_id","pattern":"{name} ({members})"},"nullable":true},{"name":"addresses","title":"Addresses","type":"one_to_many","params":[{"id":0,"create_new_row":true,"remove_row":true},{"id":1,"create_new_row":true,"remove_row":true}],"reference":{"table":"user_addresses","primary_key":"id","column":"user_id","pattern":"{street}, {zip} {city}, {country}"}},{"name":"wallet","title":"Wallet","type":"one_to_one","params":[{"id":0,"create_new_row":true,"remove_row":true},{"id":1,"create_new_row":true,"remove_row":true}],"reference":{"table":"wallets","primary_key":"id","column":"wallet_id","pattern":"{amount}"},"nullable":true}],"elements":{"groups":{"fields":[{"name":"name","title":"Name","type":"text","params":[{"id":0}],"rules":[{"type":"pattern","message":"Test email message.","arg":"[0-9a-z]{6}"}],"nullable":false,"hasTextarea":"false"},{"name":"type","title":"Type","type":"enum","params":[{"id":0}],"values":{"first":{"key":"first","name":"first"},"second":{"key":"second","name":"second"}},"nullable":true},{"name":"date","title":"Date","type":"date","params":[{"id":0}],"format":"YYYY-MM-DD HH:mm:ss","nullable":false},{"name":"members","title":"Members","type":"number","params":[{"id":0}],"rules":[{"type":"numeric","message":"Value must be valid number.","arg":null},{"type":"range","message":"Rule type range error","arg":[0,50]}],"unit":"EUR","separator":".","decimalPoint":",","decimals":2,"nullable":false}]},"wallets":{"fields":[{"name":"amount","title":"Amount","type":"number","params":[{"id":0}],"rules":[{"type":"numeric","message":"Value must be valid number.","arg":null}],"unit":null,"separator":".","decimalPoint":",","decimals":2,"nullable":false},{"name":"currency","title":"Currency","type":"enum","params":[{"id":0}],"values":{"CZK":{"key":"CZK","name":"CZK"},"EUR":{"key":"EUR","name":"EUR"}},"nullable":false}]},"user_addresses":{"fields":[{"name":"street","title":"Street","type":"text","params":[{"id":0}],"rules":[],"nullable":false,"hasTextarea":"true"},{"name":"city","title":"City","type":"text","params":[{"id":0}],"rules":[],"nullable":false,"hasTextarea":"false"},{"name":"zip","title":"Zip","type":"text","params":[{"id":0}],"rules":[],"nullable":false,"hasTextarea":"false"},{"name":"country","title":"Country","type":"text","params":[{"id":0}],"rules":[],"nullable":false,"hasTextarea":"false"}]},"user_companies":{"fields":[]},"companies":{"fields":[{"name":"name","title":"Name","type":"text","params":[{"id":0}],"rules":[],"nullable":false,"hasTextarea":"false"},{"name":"reg_num","title":"Reg. number","type":"text","params":[{"id":0}],"rules":[],"nullable":false,"hasTextarea":"false"},{"name":"verified","title":"Verified","type":"bool","params":[{"id":0}],"nullable":false,"description":"verified"}]}}}}';
